...
namespace core
{
    ...
    public:
        ...
        DLL_EXPORT static std::vector<std::string> get_directory_subdirs(const std::string &directory);
        DLL_EXPORT static std::string get_file_name(const std::string &path);
