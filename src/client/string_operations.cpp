...
std::string picotorrent::client::join(const std::vector<std::string> &list, const std::string &delimiter)
{
...
std::string picotorrent::client::to_string(const std::wstring &str)
{
...
std::wstring picotorrent::client::to_wstring(const std::string &str)
{
...
std::string picotorrent::client::trim(const std::string &str)
{
