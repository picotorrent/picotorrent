...
#include <picotorrent/common/ws/messages/torrent_added_message.hpp>
...
#include <picotorrent/common/ws/messages/torrent_updated_message.hpp>
...
namespace msg = picotorrent::common::ws::messages;
